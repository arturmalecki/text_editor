...
describe CommandParser do
  describe '#parse' do
    ...
    it 'should return NewImageCommand for I command' do
      expect(command_parser.parse('I 12 34')).to be_a_kind_of(NewImageCommand)
    end

    it 'should pass params to NewImageCommand' do
